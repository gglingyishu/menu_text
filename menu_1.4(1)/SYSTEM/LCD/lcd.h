...
void LCD_ShowChinese40x40(u16 x,u16 y,u8 *s,u16 fc,u16 bc,u8 sizey,u8 mode);//显示单个40x40汉字
void LCD_ShowChinese48x48(u16 x,u16 y,u8 *s,u16 fc,u16 bc,u8 sizey,u8 mode);//显示单个48x48汉字
void LCD_ShowString40x40(u16 x,u16 y,u8 *s,u16 fc,u16 bc,u8 sizey,u8 mode);
...
void LCD_ShowStr(u16 x,u16 y,const u8 *p,u16 color,u16 BackColor);//字符串
